...
@section('content')
 <div class="container">
    ...
    <!-- Page Form -->
    <form method="post" action="{{ url('/admin/update-shipping-fee/'. $shipping_fee->id)}}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
    <div class="form-group">
        <div class="row ">
            <div class="col-md-6">
                ...
                <input id="shipping" type="number" class="form-control @error('price') is-invalid @enderror " name="shipping" value="{{ $shipping_fee->shipping }}" autocomplete="shipping" autofocus>
                @error('shipping')
