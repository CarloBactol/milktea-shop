        ...
        <div class="row ">
            <div class="col-md-6">
                ...
                <select name="size" id="size" class="form-control mb-4 @error('size') is-invalid @enderror ">
                    <option value="{{ $sizes->size }}">{{ $sizes->size == '0' ? 'REGULAR' : 'LARGE' }}</option>
                ...
                <input id="price" type="number" class="form-control @error('price') is-invalid @enderror " name="price" value="{{ $sizes->price}}" autocomplete="price" autofocus>
                @error('price')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
