        ...
        <div class="row mb-3">
            <div class="col-md-6">
               <div class="row">
                ...
                <input type="text" class=" mb-3 form-control @error('qty') is-invalid @enderror" name="qty" value="{{ old('qty') }}" autocomplete="qty" autofocus>
                @error('qty')
                ...
                <input id="name" type="text" class=" mb-3 form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" autocomplete="name" autofocus>
                @error('name')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <select name="size_id" id="" class="form-control">
                    ...
                    <option value="{{ $items->id }}">{{ $items->size == '0'? 'REGULAR' : 'LARGE' }}</option>
                    @endforeach
                </select>
                @error('size_id')
                    <span class="invalid-feedback" role="alert">
            ...
            <div class="col-md-6">
                ...
                <textarea id="editor" class="form-control @error('description') is-invalid @enderror"  value="{{ old('description') }}" name="description" id="floatingTextarea" cols="80" rows="15"></textarea>
                @error('description')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
