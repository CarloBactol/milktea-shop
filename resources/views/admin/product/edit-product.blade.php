            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <div class="row">
                        ...
                        <input id="name" type="text" class="mb-3 form-control @error('name') is-invalid @enderror"
                            name="name" value="{{ $products->name }}" autocomplete="name" autofocus>
                        @error('name')
                        ...
                        <select name="size_id" id="" class="form-control">
                            ...
                            <option {{ $products->bottle_size == '1' ? 'selected' : '' }} value="1">Meduim</option>
                ...
                <div class="col-md-6">
                    ...
                    <textarea id="editor" class="form-control @error('description') is-invalid @enderror"
                        value="{{  $products->description  }}" name="description" id="floatingTextarea" cols="80"
                        rows="15">
