            ...
            <div class="col-md-7">
                <div class="card">
                    ...
                    <div class="card-footer">
                        {{-- <a href="{{ url('/confirmation') }}" class="btn btn-primary w-100">Confirmation</a> --}}
        ...
        directionsService.route(request, function (result, status) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    loadTotal()
                    swal({
                    title: 'Shipping Fee Cost has been completed! Please fill up agan the form and the same address.',
                    icon: "success",
                    timer: 10000
                }).then(function() {
...
<script>
    ...
    var options = {
        ...
        onClick(){
            ...
            var check_postal_code = parseInt(postal_code);
            ...
            if(!check_postal_code){
                $postal_code_err = "Postal code is required!, Must be a number!";
